...
<body>
  <link rel="stylesheet" href="style.less" class="cid-rgarQyhyTr" id="menu1-29" data-rv-view="618"><section class="menu cid-rgarQyhyTr" once="menu" id="menu1-29">
...
<section class="engine"><a href="https://mobirise.info/h">how to create a web page</a></section><section class="section-table cid-rhn6BvzEIr" id="table1-2a">
          ...
          <table class="table isSearch" cellspacing="0">
            <thead>
              ...
              <th class="head-item mbr-fonts-style display-7">
                      Item Name</th><th class="head-item mbr-fonts-style display-7">
                      Rate</th><th class="head-item mbr-fonts-style display-7">
                      Qty</th><th class="head-item mbr-fonts-style display-7">
                      Total</th></tr>
            </thead>
            ...
            <tr> 
              ...
              <td class="body-item mbr-fonts-style display-7">Item 1</td><td class="body-item mbr-fonts-style display-7">44</td><td class="body-item mbr-fonts-style display-7">2</td><td class="body-item mbr-fonts-style display-7">88</td></tr><tr>
                
                
                
                
              <td class="body-item mbr-fonts-style display-7">Item 2</td><td class="body-item mbr-fonts-style display-7">35</td><td class="body-item mbr-fonts-style display-7">4</td><td class="body-item mbr-fonts-style display-7">140</td></tr><tr>
                
                
                
                
              <td class="body-item mbr-fonts-style display-7">Item 3</td><td class="body-item mbr-fonts-style display-7">66</td><td class="body-item mbr-fonts-style display-7">1</td><td class="body-item mbr-fonts-style display-7">66</td></tr><tr>
                
                
                
                
              <td class="body-item mbr-fonts-style display-7">Item 4</td><td class="body-item mbr-fonts-style display-7">70</td><td class="body-item mbr-fonts-style display-7">7</td><td class="body-item mbr-fonts-style display-7">490</td></tr></tbody>
          </table>
        </div>
            ...
            <div class="col-12 col-md-3">
                <div class="media-wrap">
                    <a href="https://mobirise.co/">
                        <img src="assets/images/motorbikelogo-96x96.png" alt="Mobirise" title="">
                    </a>
                </div>
            </div>
